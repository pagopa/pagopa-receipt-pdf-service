Feature: Retrieve receipt attachments
  ...
  Scenario: Execute a request to getAttachmentDetails service
    Given a receipt with id "receipt-service-int-test-id-1" and debtorFiscalCode "VALID_FISCAL_CODE" stored on receipts datastore
    When an Http GET request is sent to the receipt-service getAttachmentDetails with path value "receipt-service-int-test-id-1" and fiscal_code param with value "VALID_FISCAL_CODE"
  ...
  Scenario: Execute a request to getAttachmentDetails service with invalid request id
    When an Http GET request is sent to the receipt-service getAttachmentDetails with path value "receipt-service-int-test-invalid" and fiscal_code param with value "VALID_FISCAL_CODE"
  ...
  Scenario: Execute a request to getAttachment service
    ...
    When an Http GET request is sent to the receipt-service getAttachment with path value "receipt-service-int-test-id-3" and "VALID_ATTACHMENT_NAME.pdf" and fiscal_code param with value "VALID_FISCAL_CODE"
    Then response has a 200 Http status
  ...
  Scenario: Execute a request to getAttachment service with invalid request id
    When an Http GET request is sent to the receipt-service getAttachment with path value "receipt-service-int-test-invalid" and "VALID_ATTACHMENT_NAME.pdf" and fiscal_code param with value "VALID_FISCAL_CODE"
    Then response has a 404 Http status
    And application error code is "PDFS_800"
  ...
  Scenario: Execute a request to getAttachment service with invalid attachment name
    Given a receipt with id "receipt-service-int-test-id-5" and debtorFiscalCode "VALID_FISCAL_CODE" and mdAttachmentName "INVALID_ATTACHMENT_NAME.pdf" stored on receipts datastore
    When an Http GET request is sent to the receipt-service getAttachment with path value "receipt-service-int-test-id-5" and "INVALID_ATTACHMENT_NAME.pdf" and fiscal_code param with value "VALID_FISCAL_CODE"
    Then response has a 404 Http status
