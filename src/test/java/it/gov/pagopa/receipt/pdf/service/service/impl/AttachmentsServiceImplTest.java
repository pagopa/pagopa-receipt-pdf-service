...
class AttachmentsServiceImplTest {
  ...
  @Inject private AttachmentsService sut;

  @BeforeEach
  void init() {
    Mockito.reset(cosmosClientReceiptsMock, receiptBlobClientMock, restClientMock);

    when(restClientMock.searchToken(new SearchTokenRequest(FISCAL_CODE_A)))
        .thenReturn(new SearchTokenResponse(TOKEN_A));
    when(restClientMock.searchToken(new SearchTokenRequest(FISCAL_CODE_B)))
        .thenReturn(new SearchTokenResponse(TOKEN_B));
    when(restClientMock.searchToken(new SearchTokenRequest(MISSING_FISCAL_CODE)))
  ...
  void getAttachmentDetailsFailReceiptNull() {
    ...
    InvalidReceiptException e =
        assertThrows(
            ...
            () -> sut.getAttachmentsDetails(anyString(), FISCAL_CODE_A));
  ...
  void getAttachmentDetailsFailEventDataNull() {
    doReturn(Receipt.builder().numRetry(0).build())
        .when(cosmosClientReceiptsMock)
        .getReceiptDocument(anyString());
  ...
  void getAttachmentDetailsFailDebtorFiscalCodeNull() {
    Receipt receipt =
        Receipt.builder()
            .eventData(EventData.builder().payerFiscalCode(UUID.randomUUID().toString()).build())
            .numRetry(0)
            .build();
        ...
        Receipt.builder()
            ...
            .eventData(
                EventData.builder()
                    ...
                    .payerFiscalCode(UUID.randomUUID().toString())
                    .build())
            .mdAttach(ReceiptMetadata.builder().name(fileNameDebtor).url(urlDebtor).build())
            .numRetry(0)
            .build();
  ...
  void getAttachmentDetailsFailFiscalCodeNotAuthorized() {
    ...
    FiscalCodeNotAuthorizedException e =
        assertThrows(
            FiscalCodeNotAuthorizedException.class,
            () -> sut.getAttachmentsDetails(anyString(), FISCAL_CODE_B));
  ...
  void getAttachmentSuccessWithDifferentPayerDebtorPayerRequestPayerReceipt() {
    ...
    doReturn(mock(File.class))
        ...
        .getAttachmentFromBlobStorage(anyString());
  ...
  void getAttachmentCartPayerSuccess() {
                    ...
                    .cart(
                        List.of(
                            CartPayment.builder()
                                ...
                                .mdAttach(ReceiptMetadata.builder().name(fileNameDebtor).build())
                                .build()))
                    .build())
            .build();
    ...
    when(restClientMock.searchToken(new SearchTokenRequest(payerFiscalCode)))
        .thenReturn(new SearchTokenResponse(TOKEN_A));
    doReturn(mock(File.class))
        .when(receiptBlobClientMock)
        .getAttachmentFromBlobStorage(anyString());
  ...
  void getAttachmentCartDebtorSuccess() {
    ...
    when(restClientMock.searchToken(new SearchTokenRequest(debtorFiscalCode)))
        .thenReturn(new SearchTokenResponse(TOKEN_B));
    doReturn(mock(File.class))
        .when(receiptBlobClientMock)
        .getAttachmentFromBlobStorage(anyString());
  ...
  void getAttachmentCarPayloadNull() {
    String fileNamePayer = "file2.pdf";
    String payerFiscalCode = "12345";
    CartForReceipt cart = CartForReceipt.builder().payload(null).build();
  ...
  void getAttachmentCarListNull() {
    ...
    String payerFiscalCode = "12345";
    CartForReceipt cart =
        CartForReceipt.builder().payload(Payload.builder().cart(null).build()).build();
  ...
  void getAttachmentCarDebtorNull() {
    ...
    CartForReceipt cart =
        CartForReceipt.builder()
            .payload(
                Payload.builder()
                    .cart(List.of(CartPayment.builder().debtorFiscalCode(null).build()))
                    .build())
            .build();
        ...
        CartForReceipt.builder()
            .payload(
                Payload.builder()
                    ...
                    .cart(
                        List.of(
                            CartPayment.builder().debtorFiscalCode(TOKEN_B).mdAttach(null).build()))
                    .build())
            .build();
  ...
  private Receipt buildReceiptWithDifferentPayerDebtor(
      String id, String fileNameDebtor, String fileNamePayer) {
    return Receipt.builder()
        .id(id)
        .eventData(EventData.builder().debtorFiscalCode(TOKEN_A).payerFiscalCode(TOKEN_B).build())
        .mdAttach(
            ReceiptMetadata.builder().name(fileNameDebtor).url("file/" + fileNameDebtor).build())
        .mdAttachPayer(
            ReceiptMetadata.builder().name(fileNamePayer).url("file/" + fileNamePayer).build())
        .numRetry(0)
        .build();
  }
  ...
  private Receipt buildReceiptWithSamePayerDebtor(String id, String fileNameDebtor) {
    return Receipt.builder()
        .id(id)
        .eventData(EventData.builder().debtorFiscalCode(TOKEN_A).payerFiscalCode(TOKEN_A).build())
        .mdAttach(
            ReceiptMetadata.builder().name(fileNameDebtor).url("file/" + fileNameDebtor).build())
        .numRetry(0)
        .build();
  ...
  void getAttachmentsDetails_receipt_success_payer() throws Exception {
    ...
    Receipt receipt =
        Receipt.builder()
            .id(id)
            .eventData(EventData.builder().debtorFiscalCode(debtor).payerFiscalCode(payer).build())
  ...
  void getAttachmentsDetails_receipt_not_authorized() {
    ...
    FiscalCodeNotAuthorizedException ex =
        assertThrows(
            FiscalCodeNotAuthorizedException.class,
  ...
  void getAttachmentsDetails_receipt_null() {
    ...
    InvalidReceiptException ex =
        assertThrows(
            InvalidReceiptException.class, () -> sut.getAttachmentsDetails("id4", "FCODE"));
  ...
  void getAttachmentsDetails_cart_success_payer() throws Exception {
    ...
    AttachmentsDetailsResponse resp =
  ...
  void getAttachmentsDetails_cart_success_debtor() throws Exception {
    ...
    AttachmentsDetailsResponse resp =
        sut.getAttachmentsDetails(cartId + AttachmentsServiceImpl.CART + bizId, debtor);
