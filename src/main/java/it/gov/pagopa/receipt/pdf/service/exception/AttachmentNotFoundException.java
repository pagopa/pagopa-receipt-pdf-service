...
public class AttachmentNotFoundException extends PdfServiceException {
  ...
  /**
   * Constructs new exception with provided error code, message and the name of the attachment that
   * was not found
   *
   * @param errorCode Error code
   * @param message Detail message
  ...
  public AttachmentNotFoundException(
      AppErrorCodeEnum errorCode, String message, String attachmentName) {
    super(errorCode, message);
    this.attachmentName = attachmentName;
  }

  /**
   * Constructs new exception with provided error code, message, the name of the attachment that was
   * not found and cause
   *
   * @param errorCode Error code
   * @param message Detail message
   ...
   */
  public AttachmentNotFoundException(
      AppErrorCodeEnum errorCode, String message, String attachmentName, Throwable cause) {
    super(errorCode, message, cause);
    this.attachmentName = attachmentName;
  }
