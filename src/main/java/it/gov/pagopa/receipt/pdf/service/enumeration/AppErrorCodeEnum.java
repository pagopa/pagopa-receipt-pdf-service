...
public enum AppErrorCodeEnum {
  ...
  PDFS_500(
      "PDFS_500",
      "I/O error when reading the temporary file with the receipt PDF content retrieved from Blob"
          + " Storage"),

  PDFS_600(
      "PDFS_600",
      "I/O error when creating the temporary directory to download the receipt PDF from Blob"
          + " Storage"),
  PDFS_601("PDFS_601", "I/O error when downloading the PDF receipt from Blob Storage"),
  PDFS_602(
      "PDFS_602",
      "Error when downloading the PDF receipt from Blob Storage, the requested attachment was not"
          + " found"),
  ...
  PDFS_707("PDFS_707", "The retrieved cart is null"),
  PDFS_708("PDFS_708", "The retrieved cart has null payload"),
  PDFS_709("PDFS_709", "The retrieved cart has null debtors fiscal code"),
