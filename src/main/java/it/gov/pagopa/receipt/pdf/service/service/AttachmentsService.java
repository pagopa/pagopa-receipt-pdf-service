...
public interface AttachmentsService {
  ...
  /**
   * Retrieve the attachment detail of the receipt with the provided id, only if the fiscal code is
   ...
   * @throws FiscalCodeNotAuthorizedException thrown if the fiscal code is not authorized to access
   *     the requested receipt
   */
  AttachmentsDetailsResponse getAttachmentsDetails(String thirdPartyId, String requestFiscalCode)
  ...
  /**
   * Retrieve the attachment of the receipt with the provided id using the given attachment url,
   * only if the fiscal code is authorized to access it
   *
   * @param thirdPartyId the id of the receipt
   * @param requestFiscalCode the fiscal code of the user that request the receipt
   ...
   * @throws BlobStorageClientException thrown for error when retrieving the attachment from the
   *     Blob Storage
